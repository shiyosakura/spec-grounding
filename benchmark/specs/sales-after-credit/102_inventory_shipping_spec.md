...
> Referenced data:
> - `01_master_data.md` (Product Category, Product Master, Customer Master)
> - `02_persistent_data.md` (Product Inventory, Shipping Instruction Data, Shipping Instruction Line Items, Shipping Line Items, Order Data, Order Line Items, Receiving Data, Receiving Line Items)
> - `03_screen_data.md` (Inventory List Screen, Shipping Instruction List Screen, Shipping Work Screen, Receiving Registration Screen)

---

## §1. Process Triggers and Overview

This specification defines all Processes for the 4 screens of the Inventory & Shipping Management Module (Inventory List Screen, Shipping Instruction List Screen, Shipping Work Screen, Receiving Registration Screen).
