...
> 4 modules (Order Management, Inventory & Shipping Management, Invoice & Payment Management, Master Management) with 15 screens.
...
> Out of scope: accounting journal integration, EDI integration, split orders, returns processing, detailed consumption tax rates (reduced tax rates, etc.).
